...
The mobile app currently uses Expo default icons/splash assets. Add tracked assets under
`mobile/assets/` and reference them from `mobile/app.json` before replacing the defaults.
